    ...
    return {
        ...
        click: function () {
            $('#btnlogout').click(function () {
                $.get('controller/acesso_controller.php?act=logout', function (rt) {
                    console.log(rt);
                    $.cookie("__spnfus", "");
        ...
        attachFormValidator: function (elements) {
            ...
            var regularConstraintsMessages = [
			...
			},
                {
                    ...
                    newMessage: "O e-mail inserido não é válido."
			},
                {
        ...
        if (!isNoviBuilder && !isIE && !isMobile) {
            ...
            for (var i = 0; i < plugins.rdParallax.length; i++) {
                ...
                for (var n = 0; n < $layers.length; n++) {
                    var layer = $($layers[n]);
                    layer.css({
                        'background-image': 'url(' + layer.attr('data-url') + ')'
                    });
                }
            }
        }
